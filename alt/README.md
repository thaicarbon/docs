...
It is very likely that `alt` does not support the currently selected architecture (`arm32v6`).
...
The `arm32v6/alt:latest` tag will always point the latest stable release (which is, at the time of this writing, `arm32v6/alt:p8`).
