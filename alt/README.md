...
It is very likely that `alt` does not support the currently selected architecture (`s390x`).
...
The `s390x/alt:latest` tag will always point the latest stable release (which is, at the time of this writing, `s390x/alt:p8`).
