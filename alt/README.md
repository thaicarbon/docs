...
It is very likely that `alt` does not support the currently selected architecture (`arm32v5`).
...
The `arm32v5/alt:latest` tag will always point the latest stable release (which is, at the time of this writing, `arm32v5/alt:p8`).
